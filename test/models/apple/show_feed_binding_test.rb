...
module Apple
  describe ShowFeedBinding do
    ...
    describe ".backfill_show_feed_bindings!" do
      it "creates a binding and sets the config from a public feed sync log" do
        ...
        report = ShowFeedBinding.backfill_show_feed_bindings!
      ...
      it "falls back to the private feed apple show id" do
        ...
        ShowFeedBinding.backfill_show_feed_bindings!
      ...
      it "can dry run without writing" do
        ...
        assert_no_difference "ShowFeedBinding.count" do
          report = ShowFeedBinding.backfill_show_feed_bindings!(dry_run: true)
    ...
    describe ".verify_routing_equivalence!" do
      it "reports zero mismatches after backfill" do
        ...
        report = ShowFeedBinding.verify_routing_equivalence!
