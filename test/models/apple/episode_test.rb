...
describe Apple::Episode do
  ...
  describe "#apple_published?" do
    ...
    it "differs from the local episode publishing state" do
      assert apple_episode.apple_published?
  ...
  describe "#needs_media_version?" do
    ...
    it "should be true if the delivery status is nil or has nil attrs" do
      ...
      assert_nil apple_episode.delivery_status
      assert apple_episode.delivery_status(true).source_media_version_id.nil?
  ...
  describe "#synced_with_apple?" do
    ...
    it "should be false when drafting" do
      ep = build(:delivered_apple_episode, show: apple_show)
