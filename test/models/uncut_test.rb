...
describe Uncut do
  ...
  describe "#validate_segmentation" do
    ...
    it "checks for an array of positive numerics" do
      ...
      uncut.segmentation = [0, 1, 2.2, 3.9999]
      assert uncut.valid?

      uncut.segmentation = [0, 1, 2.2, "3"]
      refute uncut.valid?

      uncut.segmentation = [-1, 0, 1, 2.2]
      refute uncut.valid?
    end
    ...
    it "checks for an ordered array" do
      ...
      uncut.segmentation = [0, 2.2, 1, 3.9999]
      refute uncut.valid?

      uncut.segmentation = [0, [1, 3.9999], 2.2]
      refute uncut.valid?
    end
  end
end
