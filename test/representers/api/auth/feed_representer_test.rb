...
describe Api::Auth::FeedRepresenter do
  ...
  it "has feed and itunes images" do
    create(:feed_image, feed: feed, description: "d1")
    create(:itunes_image, feed: feed, description: "d2", created_at: 1.minute.ago)
    create(:itunes_image, feed: feed, description: "d3", status: "error")
