...
module EpisodeMetrics
  ...
  def dropday_sum
    ...
    metrics_cache_fetch("#{metrics_cache_key}/dropday_sum", expires_in: 28.days) do
  ...
  def sparkline_downloads
    ...
    metrics_cache_fetch("#{metrics_cache_key}/sparkline_downloads", expires_in: expiration) do
