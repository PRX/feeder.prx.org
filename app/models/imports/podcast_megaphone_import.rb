...
class PodcastMegaphoneImport < PodcastImport
  store :config, accessors: [:megaphone_podcast_id, :megaphone_podcast, :override_enclosures, :new_episodes_only], coder: JSON
  ...
  def create_or_update_podcast!
    self.megaphone_podcast ||= find_megaphone_podcast
  ...
  def find_megaphone_podcast(mf = megaphone_feed, mpid = megaphone_podcast_id)
    Megaphone::Podcast.find_megaphone_podcast(mf, mpid)
  end
  ...
  def create_or_update_episode_imports!
    update(feed_episode_count: megaphone_episodes.total)
